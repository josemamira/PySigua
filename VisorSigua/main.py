...
class runApp(QtGui.QMainWindow, form.Ui_MainWindow):
    def __init__(self):
        ...
        # cargar combo
        params = ['172.25.224.197', "5432",'sigua', 'espacios', 'siguadmin']
    ...
    def mapaPlantillaPdf(self):
        ...
        if not directory:
            ...
            # Sustituir textos
            substitution_map = {'TITULO': u'TEMÁTICO','EDIFICIO':self.comboBox.currentText(),'FECHA': time.strftime("%d/%m/%Y") ,'AUTOR': u'Vic. Campus','ORGANISMO': 'Universidad de Alicante'}
...
def main():
    ...
    app.setPrefixPath(qgis_prefix) # no poner true/false al final
